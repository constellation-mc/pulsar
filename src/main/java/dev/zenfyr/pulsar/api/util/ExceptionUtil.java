...
import dev.zenfyr.pulsar.api.util.functions.ThrowingConsumer;
import dev.zenfyr.pulsar.api.util.functions.ThrowingFunction;
import dev.zenfyr.pulsar.api.util.functions.ThrowingRunnable;
...
public class ExceptionUtil {
  ...
  /**
   * Registers a new unwrapper for the {@link ExceptionUtil#unwrap(Throwable)} method.
   *
   ...
   *
   * <p> Additional unwrappers can be registered using {@link ExceptionUtil#registerUnwrapper(Class, Function)}.
   *
